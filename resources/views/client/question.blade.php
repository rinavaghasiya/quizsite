                            ...
                            <div class="basic-form">
                                <form>
                                   ...
                                   <span class="questionspan"> C <input type="radio" value="c" name="ans" id="ans" class="questioninput"/> {{$data->c}} <br/></span>
                                    ...
                                    <br>
                                    <button type="submit" class="btn" onclick="return clickButton();" id="send_form" style="background: #b5a264; border: 1px solid #b5a264;">Next</button>
                                </form>
                                <p id="msg"></p>
                            </div>
...
function clickButton(){
    var qans=document.getElementById('ans').value;
